...
#ifndef GX_DBBASE_DLL_2021_01_06
#define GX_DBBASE_DLL_2021_01_06


	   
#ifdef DSDBBASE_EXPORTS 
	#define DS_DBBASE_DLL __declspec(dllexport)
#else
	#define	DS_DBBASE_DLL __declspec(dllimport)
#endif

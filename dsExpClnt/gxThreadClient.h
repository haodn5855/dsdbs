...
private:
	...
	CgxClient m_Client ; 
private:
	int OnAckInsertMsg(char *_pMsg , int _nLen);
	int OnAckSelectMsg(char *_pMsg , int _nLen);
	int OnAckUpdateMsg(char *_pMsg , int _nLen);
	int OnAckDeleteMsg(char *_pMsg , int _nLen);
};

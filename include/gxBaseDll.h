...
#ifndef GX_BASE_DLL_2012_03_31
#define GX_BASE_DLL_2012_03_31

 
	   
#ifdef DSBASE_EXPORTS 
	#define DS_BASE_DLL __declspec(dllexport)
#else
	#define	DS_BASE_DLL __declspec(dllimport)
#endif
